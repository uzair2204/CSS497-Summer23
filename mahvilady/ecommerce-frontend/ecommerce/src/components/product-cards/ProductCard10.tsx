...
import { calculateDiscountAsStr, currency, getTheme } from "@utils/utils";
...
const ProductCard10: FC<ProductCard10Props> = (props) => {
  ...
  const handleCartAmountChange = (qty: number) => () => {
    dispatch({
      ...
      payload: { product:{price, thumbnail:imgUrl, id, slug, title}, qty },
    });
  };
          ...
          <Box flex="1 1 0" minWidth="0px" mr="0.5rem">
            ...
            <FlexBox alignItems="center" mt="6px">
              <SemiSpan pr="0.5rem" fontWeight="600" color="primary.main">
                {calculateDiscountAsStr(price, off)}
              </SemiSpan>
