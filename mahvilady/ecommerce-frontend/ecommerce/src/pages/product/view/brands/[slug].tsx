...
const ProductSearchResult = () => {
  ...
  const getProduct = async () => {
    if (slug !== null && slug !== undefined) {
      ...
      let response;
      if (!applyCriteria) {
        response = await productApi.getProductsByBrandSlug(slug, page, selectedSortOption.value, selectedPaginationOption.value);
      } else {
  ...
  return (
    <Box pt="20px">
      ...
      {!loading &&
        ...
        >
          <div>
            <H5>Searching brand for “ {slug} ”</H5>
          ...
          <FlexBox alignItems="center" flexWrap="wrap">
            ...
            {isTablet && (
              ...
              >
                <ProductFilterCard brandNamesList={[]} applyFilter={callCriteria} />
              </Sidenav>
            )}
          </FlexBox>
        </FlexBox>}
