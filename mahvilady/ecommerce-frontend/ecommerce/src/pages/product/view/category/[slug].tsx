...
const ProductSearchResult = () => {
  ...
  const getProduct = async () => {
    if (slug !== null && slug !== undefined) {
      ...
      let response;
      if (!applyCriteria) {
        response = await productApi.getProductsByCategorySlug(slug, page, selectedSortOption.value, selectedPaginationOption.value);
      } else {
  ...
  return (
    <Box pt="20px">
      ...
      {!loading &&
        ...
        >
          <div>
            <H5>Searching for category “ {slug} ”</H5>
